...
public final class FlexTemplatesServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.LaunchFlexTemplateRequest,
      com.google.dataflow.v1beta3.LaunchFlexTemplateResponse> getLaunchFlexTemplateMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.LaunchFlexTemplateRequest,
      com.google.dataflow.v1beta3.LaunchFlexTemplateResponse> getLaunchFlexTemplateMethod() {
    io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.LaunchFlexTemplateRequest, com.google.dataflow.v1beta3.LaunchFlexTemplateResponse> getLaunchFlexTemplateMethod;
    if ((getLaunchFlexTemplateMethod = FlexTemplatesServiceGrpc.getLaunchFlexTemplateMethod) == null) {
      synchronized (FlexTemplatesServiceGrpc.class) {
        if ((getLaunchFlexTemplateMethod = FlexTemplatesServiceGrpc.getLaunchFlexTemplateMethod) == null) {
          FlexTemplatesServiceGrpc.getLaunchFlexTemplateMethod = getLaunchFlexTemplateMethod =
              io.grpc.MethodDescriptor.<com.google.dataflow.v1beta3.LaunchFlexTemplateRequest, com.google.dataflow.v1beta3.LaunchFlexTemplateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "LaunchFlexTemplate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.dataflow.v1beta3.LaunchFlexTemplateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.dataflow.v1beta3.LaunchFlexTemplateResponse.getDefaultInstance()))
              .setSchemaDescriptor(new FlexTemplatesServiceMethodDescriptorSupplier("LaunchFlexTemplate"))
              .build();
        }
      }
    }
  ...
  public static FlexTemplatesServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceStub>() {
        @java.lang.Override
        public FlexTemplatesServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static FlexTemplatesServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceBlockingStub>() {
        @java.lang.Override
        public FlexTemplatesServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static FlexTemplatesServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FlexTemplatesServiceFutureStub>() {
        @java.lang.Override
        public FlexTemplatesServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class FlexTemplatesServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void launchFlexTemplate(com.google.dataflow.v1beta3.LaunchFlexTemplateRequest request,
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.LaunchFlexTemplateResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getLaunchFlexTemplateMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class FlexTemplatesServiceStub extends io.grpc.stub.AbstractAsyncStub<FlexTemplatesServiceStub> {
    private FlexTemplatesServiceStub(
    ...
    public void launchFlexTemplate(com.google.dataflow.v1beta3.LaunchFlexTemplateRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getLaunchFlexTemplateMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class FlexTemplatesServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FlexTemplatesServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.dataflow.v1beta3.LaunchFlexTemplateResponse launchFlexTemplate(com.google.dataflow.v1beta3.LaunchFlexTemplateRequest request) {
   ...
   * </pre>
   */
  public static final class FlexTemplatesServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FlexTemplatesServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.LaunchFlexTemplateResponse> launchFlexTemplate(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LAUNCH_FLEX_TEMPLATE:
          serviceImpl.launchFlexTemplate((com.google.dataflow.v1beta3.LaunchFlexTemplateRequest) request,
              (io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.LaunchFlexTemplateResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FlexTemplatesServiceBaseDescriptorSupplier
