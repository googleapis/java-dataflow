...
public final class MessagesV1Beta3Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.ListJobMessagesRequest,
      com.google.dataflow.v1beta3.ListJobMessagesResponse> getListJobMessagesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.ListJobMessagesRequest,
      com.google.dataflow.v1beta3.ListJobMessagesResponse> getListJobMessagesMethod() {
    io.grpc.MethodDescriptor<com.google.dataflow.v1beta3.ListJobMessagesRequest, com.google.dataflow.v1beta3.ListJobMessagesResponse> getListJobMessagesMethod;
    if ((getListJobMessagesMethod = MessagesV1Beta3Grpc.getListJobMessagesMethod) == null) {
      synchronized (MessagesV1Beta3Grpc.class) {
        if ((getListJobMessagesMethod = MessagesV1Beta3Grpc.getListJobMessagesMethod) == null) {
          MessagesV1Beta3Grpc.getListJobMessagesMethod = getListJobMessagesMethod =
              io.grpc.MethodDescriptor.<com.google.dataflow.v1beta3.ListJobMessagesRequest, com.google.dataflow.v1beta3.ListJobMessagesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListJobMessages"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.dataflow.v1beta3.ListJobMessagesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.dataflow.v1beta3.ListJobMessagesResponse.getDefaultInstance()))
              .setSchemaDescriptor(new MessagesV1Beta3MethodDescriptorSupplier("ListJobMessages"))
              .build();
        }
      }
    }
  ...
  public static MessagesV1Beta3Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3Stub>() {
        @java.lang.Override
        public MessagesV1Beta3Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static MessagesV1Beta3BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3BlockingStub>() {
        @java.lang.Override
        public MessagesV1Beta3BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static MessagesV1Beta3FutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MessagesV1Beta3FutureStub>() {
        @java.lang.Override
        public MessagesV1Beta3FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class MessagesV1Beta3ImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listJobMessages(com.google.dataflow.v1beta3.ListJobMessagesRequest request,
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.ListJobMessagesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListJobMessagesMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class MessagesV1Beta3Stub extends io.grpc.stub.AbstractAsyncStub<MessagesV1Beta3Stub> {
    private MessagesV1Beta3Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected MessagesV1Beta3Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MessagesV1Beta3Stub(channel, callOptions);
    }
    ...
    public void listJobMessages(com.google.dataflow.v1beta3.ListJobMessagesRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListJobMessagesMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class MessagesV1Beta3BlockingStub extends io.grpc.stub.AbstractBlockingStub<MessagesV1Beta3BlockingStub> {
    private MessagesV1Beta3BlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.dataflow.v1beta3.ListJobMessagesResponse listJobMessages(com.google.dataflow.v1beta3.ListJobMessagesRequest request) {
   ...
   * </pre>
   */
  public static final class MessagesV1Beta3FutureStub extends io.grpc.stub.AbstractFutureStub<MessagesV1Beta3FutureStub> {
    private MessagesV1Beta3FutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.ListJobMessagesResponse> listJobMessages(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_JOB_MESSAGES:
          serviceImpl.listJobMessages((com.google.dataflow.v1beta3.ListJobMessagesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.ListJobMessagesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessagesV1Beta3BaseDescriptorSupplier
