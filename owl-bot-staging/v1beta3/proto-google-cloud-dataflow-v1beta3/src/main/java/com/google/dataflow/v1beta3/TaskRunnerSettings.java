 ...
 */
public final class TaskRunnerSettings extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            ...
            parallelWorkerSettings_ = input.readMessage(com.google.dataflow.v1beta3.WorkerSettings.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.dataflow.v1beta3.EnvironmentProto.internal_static_google_dataflow_v1beta3_TaskRunnerSettings_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.dataflow.v1beta3.EnvironmentProto.internal_static_google_dataflow_v1beta3_TaskRunnerSettings_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.dataflow.v1beta3.TaskRunnerSettings.class, com.google.dataflow.v1beta3.TaskRunnerSettings.Builder.class);
  }
  ...
  public com.google.dataflow.v1beta3.WorkerSettings getParallelWorkerSettings() {
    return parallelWorkerSettings_ == null ? com.google.dataflow.v1beta3.WorkerSettings.getDefaultInstance() : parallelWorkerSettings_;
  }
  /**
   * <pre>
   * The settings to pass to the parallel worker harness.
  ...
  public int getSerializedSize() {
    ...
    if (parallelWorkerSettings_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(6, getParallelWorkerSettings());
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(baseTaskDir_)) {
    ...
    if (continueOnException_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(8, continueOnException_);
    }
    if (logToSerialconsole_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(9, logToSerialconsole_);
    }
    if (alsologtostderr_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(10, alsologtostderr_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(logUploadLocation_)) {
    ...
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(streamingWorkerMainClass_)) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(19, streamingWorkerMainClass_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.dataflow.v1beta3.TaskRunnerSettings other = (com.google.dataflow.v1beta3.TaskRunnerSettings) obj;

    if (!getTaskUser()
        .equals(other.getTaskUser())) return false;
    if (!getTaskGroup()
        .equals(other.getTaskGroup())) return false;
    if (!getOauthScopesList()
        .equals(other.getOauthScopesList())) return false;
    if (!getBaseUrl()
        .equals(other.getBaseUrl())) return false;
    if (!getDataflowApiVersion()
        .equals(other.getDataflowApiVersion())) return false;
    if (hasParallelWorkerSettings() != other.hasParallelWorkerSettings()) return false;
    if (hasParallelWorkerSettings()) {
      if (!getParallelWorkerSettings()
          .equals(other.getParallelWorkerSettings())) return false;
    }
    if (!getBaseTaskDir()
        .equals(other.getBaseTaskDir())) return false;
    if (getContinueOnException()
        != other.getContinueOnException()) return false;
    if (getLogToSerialconsole()
        != other.getLogToSerialconsole()) return false;
    if (getAlsologtostderr()
        != other.getAlsologtostderr()) return false;
    if (!getLogUploadLocation()
        .equals(other.getLogUploadLocation())) return false;
    if (!getLogDir()
        .equals(other.getLogDir())) return false;
    if (!getTempStoragePrefix()
        .equals(other.getTempStoragePrefix())) return false;
    if (!getHarnessCommand()
        .equals(other.getHarnessCommand())) return false;
    if (!getWorkflowFileName()
        .equals(other.getWorkflowFileName())) return false;
    if (!getCommandlinesFileName()
        .equals(other.getCommandlinesFileName())) return false;
    if (!getVmId()
        .equals(other.getVmId())) return false;
    if (!getLanguageHint()
        .equals(other.getLanguageHint())) return false;
    if (!getStreamingWorkerMainClass()
        .equals(other.getStreamingWorkerMainClass())) return false;
  ...
  public static com.google.dataflow.v1beta3.TaskRunnerSettings parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.dataflow.v1beta3.TaskRunnerSettings buildPartial() {
      com.google.dataflow.v1beta3.TaskRunnerSettings result = new com.google.dataflow.v1beta3.TaskRunnerSettings(this);
     ...
     * @return This builder for chaining.
     */
    public Builder setTaskUserBytes(
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setTaskGroupBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setDataflowApiVersion(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setDataflowApiVersionBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.WorkerSettings, com.google.dataflow.v1beta3.WorkerSettings.Builder, com.google.dataflow.v1beta3.WorkerSettingsOrBuilder> parallelWorkerSettingsBuilder_;
    /**
     * <pre>
     * The settings to pass to the parallel worker harness.
     * </pre>
      ...
      if (parallelWorkerSettingsBuilder_ == null) {
        if (parallelWorkerSettings_ != null) {
          parallelWorkerSettings_ =
            com.google.dataflow.v1beta3.WorkerSettings.newBuilder(parallelWorkerSettings_).mergeFrom(value).buildPartial();
        } else {
          parallelWorkerSettings_ = value;
        }
        onChanged();
    ...
    public com.google.dataflow.v1beta3.WorkerSettingsOrBuilder getParallelWorkerSettingsOrBuilder() {
      if (parallelWorkerSettingsBuilder_ != null) {
        ...
        return parallelWorkerSettings_ == null ?
            com.google.dataflow.v1beta3.WorkerSettings.getDefaultInstance() : parallelWorkerSettings_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.WorkerSettings, com.google.dataflow.v1beta3.WorkerSettings.Builder, com.google.dataflow.v1beta3.WorkerSettingsOrBuilder> 
        getParallelWorkerSettingsFieldBuilder() {
      if (parallelWorkerSettingsBuilder_ == null) {
        parallelWorkerSettingsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.dataflow.v1beta3.WorkerSettings, com.google.dataflow.v1beta3.WorkerSettings.Builder, com.google.dataflow.v1beta3.WorkerSettingsOrBuilder>(
     ...
     * @return This builder for chaining.
     */
    public Builder setBaseTaskDirBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setLogUploadLocation(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setLogUploadLocationBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setHarnessCommand(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setHarnessCommandBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setWorkflowFileName(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setWorkflowFileNameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setCommandlinesFileName(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setCommandlinesFileNameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setLanguageHint(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setLanguageHintBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setStreamingWorkerMainClass(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setStreamingWorkerMainClassBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  ...
  private static final com.google.protobuf.Parser<TaskRunnerSettings>
      PARSER = new com.google.protobuf.AbstractParser<TaskRunnerSettings>() {
    @java.lang.Override
