...
The Maven artifact coordinates (`com.google.cloud:google-cloud-dataflow`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-dataflow:0.14.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dataflow" % "0.14.0"
```
